  ...
  return (
    <div className="max-w-3xl mx-auto p-6">
      <div className="bg-white rounded-lg shadow-lg p-8">
        <h2 className="text-2xl font-bold text-center mb-8">Assignment</h2>
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <button className="w-full border-2 border-blue-600 text-blue-600 py-4 rounded-lg font-medium hover:bg-blue-50 transition-colors">
