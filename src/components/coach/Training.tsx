...
export default function Training() {
  return (
    <div className="p-6 flex-1 bg-white rounded-2xl shadow-sm">
      {/* Page Title */}
      ...
      <section>
        ...
        <div className="flex items-center justify-between flex-wrap">
          {[1, 2, 3, 4].map((_, i) => (
            <div
              key={i}
              className="bg-white w-[348.48px] rounded-xl p-[6px] shadow-sm overflow-hidden hover:shadow-md transition"
            >
              ...
              <div className="py-4 px-4">
                ...
                <button className="bg-blue-600 text-white w-full py-2 rounded-lg text-sm font-medium hover:bg-blue-700 transition">
                  Start now 🔒
                </button>
              </div>
            </div>
