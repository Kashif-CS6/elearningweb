...
const Chat = () => {
  ...
  return (
    <div className="my-20 md:my-0  md:h-screen flex items-center  justify-center">
      <div className="w-80 mx-2 md:w-[747.18px] h-[500px] md:h-[500px] border border-gray-200 md:mx-auto bg-white rounded-[6px] md:p-4 md:px-2 shadow-lg overflow-x-hidden">
